...
for (const g of guides) {
  ...
  fs.writeFileSync(output, shell({ title:`${g.title} | Bona Fide`, description:g.description, canonical, jsonld:schema([article,breadcrumb]), body, image:`/assets/guides/${g.featureImage}` }));
}
